...
\begin{theorem}
    Let $F, F'$ be Galois over $k = F \cap F'$. Then, $\gal FF'/k = \gal F/k \times \gal F'/k$.
    \begin{proof}
...
\begin{example}
    \begin{itemize}
        ...
        The polynomial is only irreducible if and only if it has no root in $k$.        
        ...
        as a symmetric function of the roots (as it's expressible in terms of coefficients $a$ and $b$, $\Delta = - 4a^3 - 27b^2$).
        ...
        with Galois group $\Sigma_3$. 
        
        Otherwise, if $\Delta \in k^2$ wherein $\delta \in k$, then the Galois group
