...
\def\coursenumber{Math202A}
\def\class{Intro to Topology and Analysis}
...
\renewtheorem{proof}[definition]{Proof}
\renewtheorem{corollary}[definition]{Corollary}
\renewtheorem{lemma}[definition]{Lemma}
\newtheorem{algothm}[definition]{Algorithm}
\newtheorem{ptheorem}[definition]{PseudoTheorem}
