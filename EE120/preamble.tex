...
\usepackage{dsptricks,dspfunctions,dspblocks} % dsp
...
\def\coursenumber{EE 120}
\def\class{Signals and Systems}
...
%%% DSP
% Commands
\newcommandx{\bdsp}[4][1=-3 2=3 3=-1.2 4=1.2]{\begin{dspPlot}{#1, #2}{#3, #4}}
\newcommand{\edsp}{\end{dspPlot}}
