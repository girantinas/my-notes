...
\begin{center}
\begin{quantikz}
   \lstick[wires=3]{$\ket{x}$} & \ctrl{3}\qw & \qw & \qw & \qw & \qw & \qw\\ 
                      & \qw & \ctrl{2}\qw & \ctrl{3}\qw & \qw & \qw & \qw\\ 
                      & \qw & \qw         & \qw & \ctrl{2}\qw & \qw & \qw \\
   \lstick{$\ket{0}$} & \targ\qw & \targ\qw & \qw & \qw & \qw & \meter{}\\ 
   \lstick{$\ket{0}$} & \qw &      \qw &    \targ\qw & \targ\qw & \qw & \meter{} \\ 
\end{quantikz}
\end{center}
